...
import ApiUpdateMasterGemstone from '../../../api/manager/ApiUpdateMasterGemstone';

function UpdateMasterGemstonePopup({ data, setIsOpenUpdatePopup }) {
...
export default UpdateMasterGemstonePopup;