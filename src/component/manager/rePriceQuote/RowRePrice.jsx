...
function RowRePrice({ data }) {
   ...
   return (
      <>
         <Link to={`/manager/re-price-quote/${data?.requirementId}`}>
            {/* Requirement rows */}
            <div className="grid grid-cols-4 gap-x-[1rem] py-[1rem] px-[2.25rem] border-t-[1px] border-solid border-[#e9eaf3] cursor-pointer">
               ...
               <div className="flex items-center">
                  ...
                  <Chip label={'Re-price Quote'} color={'warning'} variant='outlined' sx={{ fontSize: '14px', fontWeight: 400 }} />
               </div>
               <div className="flex items-center">
